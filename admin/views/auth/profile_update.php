...
$img_url = ($model->profile_photo!='')?(Utils::IMG_URL($model->profile_photo)):'theme/images/icons/upload_img.png';
        ...
        <div class="row">
                <div class="col-sm-12 col-xs-12">
                    <div class="exp__Frm--btn"> 
                        <?= Html::submitButton('Update Profile', ['class' => 'btn btn_primary cst_btn mr-10']) ?>
