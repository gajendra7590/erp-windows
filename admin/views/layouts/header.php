...
<header class="app-header">
        <div class="app-header__logo app_header_block">
            <a href="javascript:void(0)">
                <span class="sidebar_logo_img">ERP</span>
            </a>
        </div>
        ...
        <div class="sidebar_toggle_btn">
            <a class="app-sidebar__toggle" href="javascript:Void(0)" data-toggle="sidebar" aria-label="Hide Sidebar">
                <span class="toogle_left">
                        <img src="<?= Url::to('@web/theme/images/icons/toggle_left.png');?>" class="toggle_left">
                    </span>
                <span class="toogle_right">
                        <img src="<?= Url::to('@web/theme/images/icons/toggle_right.png')?>" class="toggle_right">
                    </span>
            </a>
        </div>
        <!-- Navbar Right Menu-->
        ...
        <div class="app-nav-right">
            <div class="mobile_toggle_right">
                ...
                <a class="top_heaer_right" href="JavaScript:Void(0);">
                    <img src="<?= Url::to('@web/theme/images/icons/dropdown_dot.png'); ?>" alt="icon">
                </a>
            </div>
            ...
            <ul class="topheader_right_content">
                <li>
                    <a href="#" class="notifaction">
                        <img src="<?= Url::to('@web/theme/images/icons/notification.png')?>" alt="notifaction"> <span class="notication_circle">
                                2
                            </span>
                    </a>
                </li> 
                ...
                <div class="notification_wrapper">
                    <div class="notification_box">
                        <div class="cross_icon">
                            <img src="<?= Url::to('@web/theme/images/icons/close.png');?>" alt="close">
                        </div>
                        ...
                        <div class="notification_list">
                            <a href="#" class="notification_item">
                                <div class="notification_item_icon">
                                    <img src="<?= Url::to('@web/theme/images/icons/order_icn.png')?>" alt="icon">
                                </div>
