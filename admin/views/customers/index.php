                    ...
                    <div class="row">
                        <div class="col-sm-12">
                                <div class="Tble-cst--btn">
                                    <a href="<?= Url::to(['/customers/create']);?>" class="add_new_btn" title="Add Client">
                                        ...
                                        'buttons'=>[
                                            'delete'=>function ($url, $model, $key) {  
                                                return Html::tag('a', '<i class="fa fa-trash-o" aria-hidden="true"></i>',
                                                    ...
                                                    'data-pjax' => 0,
                                                    'title' => 'Archieve Customer',
                                                    'data-method' => 'post',
                                                    'data-confirm' => 'Are you sure you want to archive this customer?',
                                                    'href'=> Url::to(['customers/delete?id='.$model->id]),
                                                    ]
                                                ); 
                                            },
                                            'edit'=>function ($url, $model, $key) {
                                                return Html::tag('a', '<i class="fa fa-pencil-square-o" aria-hidden="true"></i>',
                                                        ...
                                                        'href'=> Url::to(['customers/update?id='.$model->id]),
                                                        ]
                                                    ); 
                                            },
                                         ],
