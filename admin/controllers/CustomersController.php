...
use common\models\ManageUsersSearch;
use common\helpers\Utils;

/**
 * CustomersController implements the CRUD actions for ManageUser model.
 */
class CustomersController extends BaseController
{
    ...
    public function actionIndex()
    {
        ...
        $dataProvider->pagination->route = 'customers';
    ...
    {
        $model = ManageUsers::find()->where(['id'=>$id,'role'=>'2'])->one();
        if ($model !== null) {
            return $model;
        } 
