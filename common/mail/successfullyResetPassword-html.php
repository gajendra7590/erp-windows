                                                    ...
                                                    <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
                                                        ...
                                                        <tr>
                                                            <td style="font-family: 'Montserrat', sans-serif !important; font-size:15px; padding-top:10px;  color:#000000; line-height:24px; padding-bottom:30px;" class="para1">
                                                                You have successfully changed your Windows ERP account click below link to login your account.
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            font-size:15px; padding-top:10px;  color:#000000; line-height:24px; padding-bottom:25px;" class="para1">
                                                                If you did not create request to change password,please ignore this email.
                                                            </td>
                                                        </tr>
                                                        <tr>
