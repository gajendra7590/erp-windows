...
use yii\helpers\Url;
$this->title = 'ERP Windows - Reset Client Password';
?>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="blogs_banner">
                        <h1 class="fl-heading">Reset Your Account Password</h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5 col-md-offset-4 col-sm-12">
                    ...
                    <div class="sbs__Erp">
                        <h3 class="form__head">Reset Password</h3>
                        ...
                        <p class="lost_password">
                            <a href="<?php echo Url::to(['/login']);?>">I have an already ERP WINDOWS account?</a>
                        </p>
                    </div>
                    <?php ActiveForm::end(); ?>
                </div>
